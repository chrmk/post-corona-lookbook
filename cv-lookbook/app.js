    ...
    themes: [
      {
        ...
        trends: [
            ...
            signals: [
              {
                ...
                source: "The Guardian",
                link: "https://www.google.com/url?q=https://www.theguardian.com/society/2020/mar/16/community-aid-groups-set-up-across-uk-amid-coronavirus-crisis&sa=D&ust=1589729515225000&usg=AFQjCNG-yndh2cfWaf1pWTRCHhzOVL3_yg"
              }, {
                text: "De-urbanization: After social distancing and lockdown measures many young people living in cities returned “home” to their families often living in less densely populated areas.",
                ...
                text: "Anonymity in cities: Even though we live in crowded cities, we are only loosely connected to the local networks in them, “never knowing who neighbours are or who lives in the flat downstairs.”",
                source: "SOURCE",
                link: "LINK"
              }
            ]
          },
          {
            ...
            signals: [
              {
                text: "16% of people in Germany feel lonely or extremely lonely according to a recent survey. This is frightening, but in fact only slightly more than in pre-corona times. Loneliness is a symptom of “hypercivilisation”, according to the Zukunftsinstitut.",
                source: "SPIEGEL",
            ...
            signals: [
              {
                ...
                text: 'A recent survey indicates “signs of a re-traditionalization in which the responsibility of mothers for children and household is emphasised again."',
